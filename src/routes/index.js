...
Routes.post('/logout',AccessToken.ValidateToken,User.Logout)
...
Routes.patch("/resetpassword/:key/:email",User.ResetPassword)
Routes.get("/stats/users",User.UsersStats)
Routes.get("/stats/months",User.UsersMonthlyStats)
Routes.get("/search",Topic.searchTopic)